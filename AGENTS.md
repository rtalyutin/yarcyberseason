...
- Current CS2 playoffs use an eight-team double-elimination bracket. The confirmed opening upper-bracket pairs are numbered bobr1ki–Hunger to victories (В1, 1–8), PIVNAYA KEGA–Resistance (В2, 3–6), SAITEN x BAD.RABBIT–PSB_Bank (В3, 2–7), and GoonGang–DealDucks (В4, 4–5). Upper semifinal В5 is winner В1 vs winner В2; В6 is winner В3 vs winner В4. This places seeds 1/3/6/8 and 2/4/5/7 in opposite halves, so adjacent seed pairs 1–2, 3–4, 5–6, and 7–8 can meet in the upper bracket only in its final.
