...
- Current CS2 standings are ordered by match wins, then head-to-head when the tied teams have played, then rounds won. A team locks its table place and playoff seed as soon as it reaches three wins. Current locked seeds are bobr1ki (1), SAITEN x BAD.RABBIT (2), PIVNAYA KEGA (3), GoonGang (4), and DealDucks (5).
- Current CS2 playoffs use an eight-team double-elimination bracket. The opening upper-bracket seed pairs are 1–8, 2–7, 3–6, and 4–5 from the final group standings. Show confirmed teams in locked seed slots and numbered placeholders only for unresolved seeds.
