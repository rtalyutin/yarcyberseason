...
- Current CS2 playoffs use an eight-team double-elimination bracket. The opening upper-bracket seed pairs are 1–8, 2–7, 3–6, and 4–5 from the final group standings. Until those standings are confirmed, show numbered seed slots rather than provisional team names.
