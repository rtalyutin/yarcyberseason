...
- Current CS2 standings are ordered by match wins, then head-to-head when the tied teams have played, then rounds won. A team locks its table place and playoff seed as soon as it reaches three wins. Current locked seeds are bobr1ki (1), SAITEN x BAD.RABBIT (2), PIVNAYA KEGA (3), GoonGang (4), DealDucks (5), Hunger to victories (6), and PSB_Bank (7). The winner of Resistance — Flouk Team receives seed 8.
