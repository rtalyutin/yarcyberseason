...
- Current CS2 standings are ordered by match wins, then head-to-head when the tied teams have played, then rounds won. A team locks its table place and playoff seed as soon as it reaches three wins. Final locked seeds are bobr1ki (1), SAITEN x BAD.RABBIT (2), PIVNAYA KEGA (3), GoonGang (4), DealDucks (5), Hunger to victories (6), PSB_Bank (7), and Resistance (8).
- Current CS2 playoffs use an eight-team double-elimination bracket. The confirmed opening upper-bracket pairs are bobr1ki–Resistance (1–8), SAITEN x BAD.RABBIT–PSB_Bank (2–7), PIVNAYA KEGA–Hunger to victories (3–6), and GoonGang–DealDucks (4–5).
