...
## Последняя операция — 15.09.2026, публикация проверена
...
- Публикация на действующем домене: `SUCCEEDED`, проверена по HTTP/hash/browser; настройка бота и реальный Telegram: `NOT_STARTED` / `NOT_EXECUTED`. См. последнюю операцию выше.
...
- Следующее действие **5/8**: дать владельцу опубликованный адрес для BotFather и вместе пройти сценарии в Telegram. Размещение уже проверено. До явного подтверждения Романа не начинать шаг 6.
