...
Статус на 15.09.2026: опубликовано на действующем домене; HTTP/hash/browser проверены. Настройка BotFather и совместная приёмка Telegram НЕ выполнены.
...
Рабочая ссылка проверена: https://xn--90aiaibl0ahlel5n.xn--p1ai/tg. PR #3 слит в main, merge commit `2800ce2e4aa48642ffe0f86343b2ffb0b160bc40`. HTTP 200, опубликованные файлы совпали по SHA-256 с build; браузерные переходы и прямой вход проверены. Настройку Main Mini App/меню BotFather выполняет владелец. Проверка Telegram ещё не выполнена.
...
Выбор домена и бота уже получен. Токен в переписке не требуется. Совместную проверку закрывает только явное подтверждение Романа; до этого ежедневная задача остаётся на шаге 5.
