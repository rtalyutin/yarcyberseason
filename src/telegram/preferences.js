...
export const messages = Object.freeze({ ru: Object.freeze({
  ...
  allTeams: "Все команды", roster: "Состав", noRoster: "Состав ещё не опубликован", teamApplied: "Заявлена на турнир",
  teamMatchesPending: "Расписание и результаты появятся здесь после публикации.",
  archiveMatchesMissing: "Сведения о матчах команды в архиве не опубликованы.",
